#!/usr/bin/env node
/**
 * Phase 15B Wave 1 Batch 2 — complete missing editorial domains for partial Knowledge Records.
...
function main() {
  ...
  for (const record of PHASE15B_WAVE1_BATCH2_RECORDS) {
  ...
  console.log('Phase 15B Wave 1 Batch 2 applied.');
