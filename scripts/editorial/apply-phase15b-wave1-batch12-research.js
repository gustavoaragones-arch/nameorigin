#!/usr/bin/env node
/**
 * Phase 15B Wave 1 Batch 12 — complete missing editorial domains for partial Knowledge Records.
...
const { PHASE15B_WAVE1_BATCH12_RECORDS } = require('./phase15b-wave1-batch12-curated-data.js');
...
function main() {
  ...
  for (const record of PHASE15B_WAVE1_BATCH12_RECORDS) {
  ...
  console.log('Phase 15B Wave 1 Batch 12 applied.');
