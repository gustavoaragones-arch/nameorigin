#!/usr/bin/env node
/**
 * Phase 15B Wave 1 Batch 10 — complete missing editorial domains for partial Knowledge Records.
...
const { PHASE15B_WAVE1_BATCH10_RECORDS } = require('./phase15b-wave1-batch10-curated-data.js');
...
function main() {
  ...
  for (const record of PHASE15B_WAVE1_BATCH10_RECORDS) {
  ...
  console.log('Phase 15B Wave 1 Batch 10 applied.');
