#!/usr/bin/env node
/**
 * Phase 15B Wave 1 Batch 13 — complete missing editorial domains for partial Knowledge Records.
...
const { PHASE15B_WAVE1_BATCH13_RECORDS } = require('./phase15b-wave1-batch13-curated-data.js');
...
function main() {
  ...
  for (const record of PHASE15B_WAVE1_BATCH13_RECORDS) {
  ...
  console.log('Phase 15B Wave 1 Batch 13 applied.');
