#!/usr/bin/env node
/**
 * Phase 7B — Build Wave 2 Batch 2 editorial research file.
 * Writes data/sources/wave2-batch2-research.json only.
 */
...
const OUT_PATH = path.join(SOURCES_DIR, 'wave2-batch2-research.json');

function main() {
  const entries = WAVE2_BATCH2_RECORDS.map((record) => ({
    name: record.name,
  ...
  console.log('Phase 7B Wave 2 Batch 2 research file written.');
