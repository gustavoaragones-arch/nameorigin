#!/usr/bin/env node
/**
 * Phase 7A — Apply Wave 2 Batch 1 research to legacy overrides and domain research files,
...
function main() {
  ...
  for (const record of WAVE2_BATCH1_RECORDS) {
  ...
  console.log('Phase 7A Wave 2 Batch 1 applied.');
