...
function generateIndexPage(names, popularity, nameById) {
  ...
  const mainContent = `
    ...
    <section aria-labelledby="understanding-trends-heading">
      <h2 id="understanding-trends-heading">Understanding Baby Name Popularity Trends</h2>
      <p class="contextual">Baby name popularity reflects how often a name is chosen by parents in a given year. Rankings are typically based on national or regional data and help identify which names are widely used, steadily rising, or becoming less common over time.</p>
      <p class="contextual">Popular names often follow cultural patterns, media influence, and generational preferences. Some names remain consistently popular for decades, while others experience rapid growth due to trends, public figures, or renewed interest in traditional names.</p>
      <p class="contextual">This page provides an overview of the most popular baby names, helping you compare trends across years and discover names that are gaining attention. You can also explore individual name pages to understand their origin, meaning, and long-term popularity trajectory.</p>
    </section>
