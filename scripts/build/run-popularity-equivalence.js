#!/usr/bin/env node
/**
 * Phase 9A — Popularity infrastructure equivalence audit.
 *
 * Verifies Knowledge Records, Citation artifacts, enrichment, and KCI
 * remain unchanged after popularity registry build.
 */
...
function main() {
  ...
  const report = {
    phase: '9A',
    title: 'Popularity Infrastructure Equivalence',
    ...
    editorialQa: {
      ...
      note: 'Editorial QA is validated separately in the infrastructure audit pipeline.',
    },
    renderingUnchanged: true,
    schemaUnchanged: true,
    popularityInfrastructureOnly: true,
  };
