...
function scoreCitations(entity) {
...
function scorePopularity(entity) {
...
function scoreEntity(entity) {
  const breakdown = {
    ...
    citations: scoreCitations(entity),
    variants: scoreVariants(entity),
    popularity: scorePopularity(entity),
  };
...
function buildKnowledgeCompletenessReport(entities, generatedAt = new Date().toISOString()) {
